                        ...
                        <ul className="navbar-nav links-nav links-nav-responsive mb-2 mb-lg-0">
                            ...
                            <li className='img-navbar-collapse_pesponsive'>
                                <div className='container-icon-collapse-navbar-collapse'>
                                    <img className='icon-navbar-collapse' src="/assets/icon-navbar-collapse.png" alt="icon-navbar-collapse" />
                                    <img className='icon-navbar-collapse_2' src="/assets/icon-navbar-collapse.png" alt="icon-navbar-collapse" />
                                    <img className='icon-navbar-collapse_3' src="/assets/icon-navbar-collapse.png" alt="icon-navbar-collapse" />
                                </div>
                            </li>
                        </ul>
                    </div>
